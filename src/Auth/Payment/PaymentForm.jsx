...
//     // tanstack query implementing for getting the data from server // 
...
//     if (isPending) {
//         return <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#03373D] bg-opacity-80">
...
//         // step 2: created payment intent, connect to backend // 
...
//         //  step 3: payment confirmation logic // 
...
//                 <CardElement className=' py-5 border-b-1 border-dashed border-gray-500'
//                     options={{
//                         style: {
//                             base: {
//                                 fontSize: '13px',
