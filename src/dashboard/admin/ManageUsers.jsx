...
//     if (role === "admin") return toast.error("Admin users cannot be restricted");
...
//     if (role === "admin") return toast.error("Admin users cannot be deleted");
...
//   return (
//     <div className="p-4">
//       <h2 className="text-2xl font-bold text-[#03373D] mb-4">Manage Users</h2>
...
//                       className="p-2 rounded-full border text-[#03373D] hover:bg-[#CAEB6650]"
//                     >
//                       <FaBan />
//                     </button>
//                     <button
...
//               <span className="font-bold text-[#03373D]">Name:</span>
//               <span>{u.name}</span>
//             </div>
//             <div className="flex justify-between mb-2">
//               <span className="font-bold text-[#03373D]">Email:</span>
//               <span>{u.email}</span>
//             </div>
//             <div className="flex justify-between mb-2">
//               <span className="font-bold text-[#03373D]">Contact:</span>
//               <span>{u.contactNo}</span>
//             </div>
//             <div className="flex justify-between mb-2">
//               <span className="font-bold text-[#03373D]">Role:</span>
//               <select
//                 value={u.role}
//                 onChange={(e) => handleRoleChange(u.email, e.target.value)}
//                 disabled={u.role === "admin"}
...
//             </div>
//             <div className="flex justify-between mb-2">
//               <span className="font-bold text-[#03373D]">Joined:</span>
//               <span>{dayjs(u.createdAt).format("DD MMM YYYY")}</span>
//             </div>
